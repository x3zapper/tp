    ...
    public static Person[] getSamplePersons() {
        ...
        return new Person[] {
            new Person(
                    ...
                    getTagSet("friends"), noTz, new DateAdded(), EMPTY_NOTE
            ),
            new Person(
